  ...
  return (
    <React.Fragment>
      <div className={css.footer}>
        <div className={css.footerInnerLayer}>
          <div className={css.footerLeftContent}>
            ...
            <div className={css.socialMedia}>
              <div className={css.socialMedia_icons}>
                <FaFacebookF />
              </div>
              <div className={css.socialMedia_icons}>
                <FaInstagram />
            ...
            <div className={css.footerContentSubContent}>
              <div>
                <img
                  className={css.footerContentSubContentIcon}
                  src={mobile}
                  alt="M:"
                />
                8925-832-070, 8925-832-076
              </div>
              <div>
                <img
                  className={css.footerContentSubContentIcon}
          ...
          <div className={css.footerContent}>
            ...
            <div className={css.footerContentSubContent}>
              ...
              <Link
                target="_blank"
                href={{ pathname: "/joinuspage" }}
                className="no-underline text-[#9F9F9F]"
              >
                <div>Join Us</div>
              </Link>
              <div>Privacy Policy</div>
              <Link
                href={{ pathname: "/referandearn" }}
                className="no-underline text-[#9F9F9F]"
              >
          ...
          <div className={css.footerContent}>
            ...
            <div className={css.footerContentSubContent}>
              <Link
                href={{ pathname: "/CustomersupportPage", query: { tab: 0 } }}
                className="no-underline text-[#9F9F9F]"
              >
                <div>Raise issue</div>
              </Link>
              <Link
                href={{ pathname: "/CustomersupportPage", query: { tab: 1 } }}
                className="no-underline text-[#9F9F9F]"
              >
                <div>My issues</div>
              </Link>
              <Link
                href={{ pathname: "/CustomersupportPage", query: { tab: 2 } }}
                className="no-underline text-[#9F9F9F]"
              >
                <div>Contact us</div>
              </Link>
              <Link
                href={{ pathname: "/GetfreeEstimate" }}
                className="no-underline text-[#9F9F9F]"
              >
                <div>Get Estimate</div>
              </Link>
              <Link
                href={{ pathname: "/CustomersupportPage", query: { tab: 3 } }}
                className="no-underline text-[#9F9F9F]"
              >
                <div>FAQs</div>
              </Link>
        ...
        <div className="w-full mb-12 mt-9 text-center text-gray-500 text-xs md:text-sm px-2 break-words">
